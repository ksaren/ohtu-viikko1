...
public class Stepdefs {
    ...
    @Given("^username \"([^\"]*)\" and password \"([^\"]*)\" are created$")
    public void a_username_and_password_are_created(String username, String password) throws Throwable {
       inputLines.add("new");
    ...
    public void system_will_respond_with(String expectedOutput) throws Throwable {
        System.out.println("Then: odotetaan "+expectedOutput+", saatiin " +io.getPrints());
